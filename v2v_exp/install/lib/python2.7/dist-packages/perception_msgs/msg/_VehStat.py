...
"""autogenerated by genpy from perception_msgs/VehStat.msg. Do not edit."""
import sys
...
float64 acc"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.localization is None:
        self.localization = perception_msgs.msg.Localization()
      if self.stat is None:
        self.stat = perception_msgs.msg.InternalStat()
    else:
      self.localization = perception_msgs.msg.Localization()
      self.stat = perception_msgs.msg.InternalStat()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.localization.header.frame_id = str[start:end].decode('utf-8')
      else:
