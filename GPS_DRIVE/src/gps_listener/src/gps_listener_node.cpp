...
{  
    ...
    ROS_INFO("longitude : %f",ll2utm_msg.pose.covariance[0]);
    ROS_INFO("latitude : %f",ll2utm_msg.pose.covariance[1]);
    ROS_INFO("yaw (rad) : %f",ll2utm_msg.pose.covariance[2]);
    ROS_INFO("yaw (deg) : %f",ll2utm_msg.pose.covariance[2] / 3.1415926 * 180);
