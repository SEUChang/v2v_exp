...
(cl:defmethod cl:initialize-instance :after ((m <GPRMC>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GPRMC)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gnss_msgs-msg:<GPRMC> is deprecated: use gnss_msgs-msg:GPRMC instead.")))
...
(cl:defmethod position_status-val ((m <GPRMC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:position_status-val is deprecated.  Use gnss_msgs-msg:position_status instead.")
  (position_status m))
...
(cl:defmethod heading-val ((m <GPRMC>))
...
(cl:defmethod track-val ((m <GPRMC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:track-val is deprecated.  Use gnss_msgs-msg:track instead.")
  (track m))

(cl:ensure-generic-function 'date-val :lambda-list '(m))
(cl:defmethod date-val ((m <GPRMC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:date-val is deprecated.  Use gnss_msgs-msg:date instead.")
  (date m))

(cl:ensure-generic-function 'mag_var-val :lambda-list '(m))
(cl:defmethod mag_var-val ((m <GPRMC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:mag_var-val is deprecated.  Use gnss_msgs-msg:mag_var instead.")
  (mag_var m))

(cl:ensure-generic-function 'mag_var_direction-val :lambda-list '(m))
(cl:defmethod mag_var_direction-val ((m <GPRMC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:mag_var_direction-val is deprecated.  Use gnss_msgs-msg:mag_var_direction instead.")
  (mag_var_direction m))

(cl:ensure-generic-function 'mode_indicator-val :lambda-list '(m))
(cl:defmethod mode_indicator-val ((m <GPRMC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:mode_indicator-val is deprecated.  Use gnss_msgs-msg:mode_indicator instead.")
  (mode_indicator m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GPRMC>)))
  ...
  "3f6fb81b50ce6974426f8703c714b29c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GPRMC)))
  "Returns md5sum for a message object of type 'GPRMC"
  "3f6fb81b50ce6974426f8703c714b29c")
