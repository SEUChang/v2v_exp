...
(cl:defclass <Cmd_WF> (roslisp-msg-protocol:ros-message)
  ((enable_steering
...
(cl:defclass Cmd_WF (<Cmd_WF>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Cmd_WF>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Cmd_WF)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dnc_msgs-msg:<Cmd_WF> is deprecated: use dnc_msgs-msg:Cmd_WF instead.")))

(cl:ensure-generic-function 'enable_steering-val :lambda-list '(m))
(cl:defmethod enable_steering-val ((m <Cmd_WF>))
...
(cl:defmethod enable_braking-val ((m <Cmd_WF>))
...
(cl:defmethod enable_driving-val ((m <Cmd_WF>))
...
(cl:defmethod enable_Estop-val ((m <Cmd_WF>))
...
(cl:defmethod enable_gear-val ((m <Cmd_WF>))
...
(cl:defmethod sw_deg-val ((m <Cmd_WF>))
...
(cl:defmethod sw_rad-val ((m <Cmd_WF>))
...
(cl:defmethod speed_ms-val ((m <Cmd_WF>))
...
(cl:defmethod speed_kms-val ((m <Cmd_WF>))
...
(cl:defmethod ax_ms2-val ((m <Cmd_WF>))
...
(cl:defmethod omega_rad-val ((m <Cmd_WF>))
...
(cl:defmethod gear_mode-val ((m <Cmd_WF>))
...
(cl:defmethod steering-val ((m <Cmd_WF>))
...
(cl:defmethod speed-val ((m <Cmd_WF>))
  ...
  (speed m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Cmd_WF>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Cmd_WF>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Cmd_WF>)))
  "Returns string type for a message object of type '<Cmd_WF>"
  "dnc_msgs/Cmd_WF")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Cmd_WF)))
  "Returns string type for a message object of type 'Cmd_WF"
  "dnc_msgs/Cmd_WF")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Cmd_WF>)))
  "Returns md5sum for a message object of type '<Cmd_WF>"
  "d06405f78ad4d1752ebdd64f2ef906dc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Cmd_WF)))
  "Returns md5sum for a message object of type 'Cmd_WF"
  "d06405f78ad4d1752ebdd64f2ef906dc")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Cmd_WF>)))
  "Returns full string definition for message of type '<Cmd_WF>"
  (cl:format cl:nil "#~%#  control cmd for weifang qingsaoche~%#~%~%#########################~%~%bool enable_steering~%bool enable_braking~%bool enable_driving~%bool enable_Estop~%bool enable_gear~%#########################~%~%float32 sw_deg  # steering wheel angle~%float32 sw_rad~%float32 speed_ms~%float32 speed_kms~%float32 ax_ms2~%float32 omega_rad~%int32 gear_mode  # 0: N, // 1: forward , // 2 backward, // 3: stop~%~%#########################~%float32 steering~%float32 speed~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Cmd_WF)))
  "Returns full string definition for message of type 'Cmd_WF"
  (cl:format cl:nil "#~%#  control cmd for weifang qingsaoche~%#~%~%#########################~%~%bool enable_steering~%bool enable_braking~%bool enable_driving~%bool enable_Estop~%bool enable_gear~%#########################~%~%float32 sw_deg  # steering wheel angle~%float32 sw_rad~%float32 speed_ms~%float32 speed_kms~%float32 ax_ms2~%float32 omega_rad~%int32 gear_mode  # 0: N, // 1: forward , // 2 backward, // 3: stop~%~%#########################~%float32 steering~%float32 speed~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Cmd_WF>))
  (cl:+ 0
     1
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Cmd_WF>))
