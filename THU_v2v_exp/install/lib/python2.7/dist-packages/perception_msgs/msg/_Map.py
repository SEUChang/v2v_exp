...
"""autogenerated by genpy from perception_msgs/Map.msg. Do not edit."""
import sys
...
class Map(genpy.Message):
  _md5sum = "f311c97842ff52d6f2efb99074fbe5db"
  _type = "perception_msgs/Map"
...
string data
"""
  __slots__ = ['header','origin_utm_pt','sections','uuid','id']
  _slot_types = ['std_msgs/Header','geometry_msgs/Point','perception_msgs/Section[]','std_msgs/String','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,origin_utm_pt,sections,uuid,id
    ...
    if args or kwds:
      ...
      if self.origin_utm_pt is None:
        self.origin_utm_pt = geometry_msgs.msg.Point()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3d().pack(_x.origin_utm_pt.x, _x.origin_utm_pt.y, _x.origin_utm_pt.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.origin_utm_pt.x, _x.origin_utm_pt.y, _x.origin_utm_pt.z,) = _get_struct_3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.sections = []
