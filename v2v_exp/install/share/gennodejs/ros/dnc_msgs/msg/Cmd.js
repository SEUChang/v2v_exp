...
class Cmd {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.steering = null;
      this.speed = null;
      this.remote_flag = null;
    }
    else {
      if (initObj.hasOwnProperty('speical')) {
        this.speical = initObj.speical
      }
      else {
        this.speical = 0;
      }
      ...
      if (initObj.hasOwnProperty('remote_flag')) {
        this.remote_flag = initObj.remote_flag
      }
      else {
        this.remote_flag = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [speical]
    bufferOffset = _serializer.int32(obj.speical, buffer, bufferOffset);
    ...
    // Serialize message field [remote_flag]
    bufferOffset = _serializer.int32(obj.remote_flag, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [speical]
    data.speical = _deserializer.int32(buffer, bufferOffset);
    ...
    // Deserialize message field [remote_flag]
    data.remote_flag = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.speical !== undefined) {
      resolved.speical = msg.speical;
    }
    else {
      resolved.speical = 0
    }
    ...
    if (msg.remote_flag !== undefined) {
      resolved.remote_flag = msg.remote_flag;
    }
    else {
      resolved.remote_flag = 0
    }
