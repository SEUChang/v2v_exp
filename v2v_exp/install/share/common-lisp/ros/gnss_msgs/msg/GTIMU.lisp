...
(cl:defclass <GTIMU> (roslisp-msg-protocol:ros-message)
  ((GPSWeek
    :reader GPSWeek
    :initarg :GPSWeek
    :type cl:integer
...
(cl:defclass GTIMU (<GTIMU>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <GTIMU>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'GTIMU)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gnss_msgs-msg:<GTIMU> is deprecated: use gnss_msgs-msg:GTIMU instead.")))

(cl:ensure-generic-function 'GPSWeek-val :lambda-list '(m))
(cl:defmethod GPSWeek-val ((m <GTIMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:GPSWeek-val is deprecated.  Use gnss_msgs-msg:GPSWeek instead.")
  (GPSWeek m))

(cl:ensure-generic-function 'GPSTime-val :lambda-list '(m))
(cl:defmethod GPSTime-val ((m <GTIMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:GPSTime-val is deprecated.  Use gnss_msgs-msg:GPSTime instead.")
  (GPSTime m))

(cl:ensure-generic-function 'pitch_rate-val :lambda-list '(m))
(cl:defmethod pitch_rate-val ((m <GTIMU>))
...
(cl:defmethod roll_rate-val ((m <GTIMU>))
...
(cl:defmethod yaw_rate-val ((m <GTIMU>))
...
(cl:defmethod acc_x-val ((m <GTIMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:acc_x-val is deprecated.  Use gnss_msgs-msg:acc_x instead.")
  (acc_x m))

(cl:ensure-generic-function 'acc_y-val :lambda-list '(m))
(cl:defmethod acc_y-val ((m <GTIMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:acc_y-val is deprecated.  Use gnss_msgs-msg:acc_y instead.")
  (acc_y m))

(cl:ensure-generic-function 'acc_z-val :lambda-list '(m))
(cl:defmethod acc_z-val ((m <GTIMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:acc_z-val is deprecated.  Use gnss_msgs-msg:acc_z instead.")
  (acc_z m))

(cl:ensure-generic-function 'tpr-val :lambda-list '(m))
(cl:defmethod tpr-val ((m <GTIMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_msgs-msg:tpr-val is deprecated.  Use gnss_msgs-msg:tpr instead.")
  (tpr m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GTIMU>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'acc_z))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'tpr))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GTIMU>) istream)
  "Deserializes a message object of type '<GTIMU>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'tpr) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GTIMU>)))
  "Returns string type for a message object of type '<GTIMU>"
  "gnss_msgs/GTIMU")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GTIMU)))
  "Returns string type for a message object of type 'GTIMU"
  "gnss_msgs/GTIMU")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GTIMU>)))
  "Returns md5sum for a message object of type '<GTIMU>"
  "d78377954954abd5e348c740ac6f7798")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GTIMU)))
  "Returns md5sum for a message object of type 'GTIMU"
  "d78377954954abd5e348c740ac6f7798")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GTIMU>)))
  "Returns full string definition for message of type '<GTIMU>"
  (cl:format cl:nil "int32 GPSWeek~%float64 GPSTime~%float64 pitch_rate~%float64 roll_rate~%float64 yaw_rate~%~%float64 acc_x~%float64 acc_y~%float64 acc_z~%~%float64 tpr~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GTIMU)))
  "Returns full string definition for message of type 'GTIMU"
  (cl:format cl:nil "int32 GPSWeek~%float64 GPSTime~%float64 pitch_rate~%float64 roll_rate~%float64 yaw_rate~%~%float64 acc_x~%float64 acc_y~%float64 acc_z~%~%float64 tpr~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <GTIMU>))
  (cl:+ 0
     4
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GTIMU>))
