// Generated by gencpp from file gnss_msgs/GPGGA.msg
// DO NOT EDIT!


#ifndef GNSS_MSGS_MESSAGE_GPGGA_H
#define GNSS_MSGS_MESSAGE_GPGGA_H
...
struct GPGGA_
{
  ...
  typedef boost::shared_ptr< ::gnss_msgs::GPGGA_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gnss_msgs::GPGGA_<ContainerAllocator> const> ConstPtr;

}; // struct GPGGA_

typedef ::gnss_msgs::GPGGA_<std::allocator<void> > GPGGA;

typedef boost::shared_ptr< ::gnss_msgs::GPGGA > GPGGAPtr;
typedef boost::shared_ptr< ::gnss_msgs::GPGGA const> GPGGAConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gnss_msgs::GPGGA_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gnss_msgs::GPGGA_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::gnss_msgs::GPGGA_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gnss_msgs::GPGGA_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gnss_msgs::GPGGA_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gnss_msgs::GPGGA_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gnss_msgs::GPGGA_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gnss_msgs::GPGGA_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gnss_msgs::GPGGA_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gnss_msgs::GPGGA_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8f51cb504898f39dULL;
  static const uint64_t static_value2 = 0x8ad9f698f0b6f9cdULL;
};

template<class ContainerAllocator>
struct DataType< ::gnss_msgs::GPGGA_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gnss_msgs::GPGGA_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gnss_msgs::GPGGA_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gnss_msgs::GPGGA_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gnss_msgs::GPGGA_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // GNSS_MSGS_MESSAGE_GPGGA_H
